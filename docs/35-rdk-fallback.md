...
docs/23 §1(RDK X1) / §5 Phase 5 산출물. Kaon이 RDK Video Accelerator 프로그램 참여 → KT/SKB(RDK 친화) 어필 포인트.
...
| 모든 STB 공통 | RDK 박스 전용 (Comcast/Sky/일부 KT·SKB) |
...
| STB | 1순위 | 비고 |
|---|---|---|
| RDK 박스 (Comcast/Sky/KT·SKB 일부) | **rdk** | API 결정론, 물리 간섭 0 |
