...
- [x] LLaVA/Qwen-VL/GPT-4V/Claude/Gemini 비교 벤치 (`tools/vision_bench/`, docs/32, 2026-05-26)
...
- [x] vision tier 모델 다변화 — embedding-mcp `VISION_PROVIDER` env (ollama/anthropic/openai/gemini, docs/32, 2026-05-26)
